...
declare namespace $ {
    class $dosha_client_auth_registration extends $mol_view {
        ...
        Email_control(): $$.$mol_string;
        Email_field(): $$.$mol_form_field;
        fetch_registration(next?: any): any;
...
declare namespace $.$$ {
    class $dosha_client_auth extends $.$dosha_client_auth {
        body(): ($mol_text | $dosha_client_auth_login | $dosha_client_auth_registration)[];
        role_text(): string;
    }
}
...
declare namespace $ {
    class $dosha_client_steps extends $mol_page {
        dosha_value(next?: any): number;
        title(): string;
        body(): readonly any[];
        all_dosha_label(): string;
        All_dosha(): $$.$mol_text;
        add_dosha(next?: any): number;
...
declare namespace $ {
    class $dosha_client_city extends $mol_page {
        ...
        Description_control(): $$.$mol_string;
        Description(): $$.$mol_form_field;
        date(next?: any): string;
        Date_control(): $$.$mol_string;
...
declare namespace $ {
    class $dosha_branding extends $mol_page {
        ...
        Color_hue_text(): $$.$mol_text;
        hue(next?: any): any;
        Color_hue(): $$.$mol_number;
        Color_luma_text(): $$.$mol_text;
        luma(next?: any): any;
        Color_luma(): $$.$mol_number;
        Color_satur_text(): $$.$mol_text;
        satur(next?: any): any;
...
declare namespace $ {
    class $dosha_company_report extends $mol_page {
        title(): string;
        body(): readonly any[];
        Report_text(): $$.$mol_text;
        download(): Blob;
        Download_report_salary(): $$.$mol_button_download;
        Download_report_people(): $$.$mol_button_download;
        Download_report_rating(): $$.$mol_button_download;
        Download_report_events(): $$.$mol_button_download;
        Download_report_trainings(): $$.$mol_button_download;
...
declare namespace $ {
    class $dosha_company extends $mol_book2_catalog {
        ...
        Events_text(): $$.$mol_text;
        Download_report_events(): $$.$mol_button_download;
        Events_page(): $mol_page;
        Budget_text(): $$.$mol_text;
        Download_report_budget(): $$.$mol_button_download;
        Budget_page(): $mol_page;
        Report_page(): $$.$dosha_company_report;
        Branding_page(): $$.$dosha_branding;
