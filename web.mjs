...
var $;
(function ($) {
    class $dosha_client_auth_login extends $mol_view {
        sub() {
            return [
                this.Login_form(),
...
(function ($) {
    ...
    $.$dosha_fetch_user = $dosha_fetch_user;
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("dosha/client/auth/login/login.view.css", "[dosha_client_auth_login] {\n\tflex-direction: column;\n}\n");
})($ || ($ = {}));
//dosha/client/auth/login/-css/login.view.css.ts
;
"use strict";
var $;
(function ($) {
    class $dosha_client_auth_registration extends $mol_view {
        role(next) {
            if (next !== undefined)
                return next;
            return "user";
        ...
        Registration() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => "Регистрация";
            obj.click = (next) => this.fetch_registration(next);
            return obj;
        }
        Login() {
            const obj = new this.$.$mol_link();
    ...
    __decorate([
        $mol_mem
    ], $dosha_client_auth_registration.prototype, "role", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $dosha_client_auth_registration.prototype, "fetch_registration", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $dosha_client_auth extends $mol_page {
        ...
        Registration() {
            ...
            obj.role = (next) => this.role();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $dosha_client_auth.prototype, "role", null);
    __decorate([
        $mol_mem
    ], $dosha_client_auth.prototype, "Role", null);
    __decorate([
        $mol_mem
    ], $dosha_client_auth.prototype, "Role_text", null);
    __decorate([
        $mol_mem
...
var $;
(function ($) {
    $mol_style_attach("dosha/client/auth/auth.view.css", "[dosha_client_auth_role_text] {\n\tfont-size: 1.5rem;\n}\n");
})($ || ($ = {}));
//dosha/client/auth/-css/auth.view.css.ts
;
"use strict";
var $;
(function ($) {
...
//dosha/client/coins/-view.tree/coins.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//dosha/client/coins/coins.view.ts
;
"use strict";
var $;
(function ($) {
...
//dosha/client/coins/links/links.view.ts
;
"use strict";
var $;
(function ($) {
    class $dosha_client_history extends $mol_page {
        ...
        History_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => "# Ваши интересные истории\n\n# Сделал кормушку для белочек в лесу\n 23.07.2023\n Около месяца назад я нашёл мастера, который смог за бюджетную сумму\n Сделать кормушку для белочек и птичек\n Мы с удовольствием ходим туда с девушкой гулять,\n т.к. она находится у нас в Сказачном лесу Бору\n в г. Алексине\n Приятно видеть бабушек, которые подкармливают белочек грибами\n Я сначала не знал, что белки едят грибы и их выбросил.\n Но потом узнал и сам принёс несколько грибов - рядовок (белые, радут целыми рядами).\n Прикрепляю ссылку на изображения кормушек и ссылку на мастера. Мастера - Золотые ручки\n [Ссылка на мой vk](https://vk.com/mikhail_eco_coach?w=wall618594473_418)\n ![](https://sun9-72.userapi.com/impg/0NxH-iAsBPl_4NyWhycJbFqQ7ckxOxy947jZcQ/jk4jfkMv8zY.jpg?size=1621x2160&quality=95&sign=9fb558a93c13406ec6dae49f624fc1e5&type=album)";
            return obj;
        }
    }
    __decorate([
...
var $;
(function ($) {
    $.$dosha_strapi = (attr) => $mol_data_record({
...
var $;
(function ($) {
    class $dosha_client_training extends $mol_book2_catalog {
        menu_title() {
            return "🏋 Тренировки";
        }
        param() {
...
(function ($) {
    class $dosha_client_city extends $mol_page {
        ...
        Description() {
            const obj = new this.$.$mol_form_field();
            obj.name = () => "Описание";
            obj.Content = () => this.Description_control();
            return obj;
        }
        date(next) {
            if (next !== undefined)
        ...
        Registration() {
            const obj = new this.$.$mol_button_major();
            obj.title = () => "Добавить мероприятие";
            obj.click = (next) => this.fetch_registration(next);
            return obj;
        }
        Create_event() {
    ...
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "city", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "City_control", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "City", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Name_control", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Name", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "description", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Description_control", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Description", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "date", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Date_control", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Date_field", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "fetch_registration", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Registration", null);
    __decorate([
        $mol_mem
    ], $dosha_client_city.prototype, "Create_event", null);
...
(function ($) {
    ...
    $.$mol_icon_dice_d6 = $mol_icon_dice_d6;
})($ || ($ = {}));
//mol/icon/dice/d6/-view.tree/d6.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $mol_icon_dice_d12 extends $mol_icon {
        path() {
            return "M12,2L1.5,9.64L5.5,22H18.5L22.5,9.64L12,2M17,20H7L3.85,10.4L12,4.47L20.15,10.4L17,20M17,15.75V17H11.66V15.91C11.66,15.91 15.23,12.45 15.23,11.4C15.23,10.12 14.18,10.25 14.18,10.25C13.5,10.3 13,10.87 13,11.55H11.44C11.5,10.09 12.72,8.94 14.27,9C16.74,9 16.77,10.85 16.77,11.3C16.77,13.07 13.58,15.77 13.58,15.77L17,15.75M10.5,17H8.89V10.89L7,11.47V10.19L10.31,9H10.5V17Z";
        }
    }
    $.$mol_icon_dice_d12 = $mol_icon_dice_d12;
})($ || ($ = {}));
//mol/icon/dice/d12/-view.tree/d12.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $mol_icon_dice_d20 extends $mol_icon {
        path() {
            return "M21,16.5C21,16.88 20.79,17.21 20.47,17.38L12.57,21.82C12.41,21.94 12.21,22 12,22C11.79,22 11.59,21.94 11.43,21.82L3.53,17.38C3.21,17.21 3,16.88 3,16.5V7.5C3,7.12 3.21,6.79 3.53,6.62L11.43,2.18C11.59,2.06 11.79,2 12,2C12.21,2 12.41,2.06 12.57,2.18L20.47,6.62C20.79,6.79 21,7.12 21,7.5V16.5M12,4.15L5,8.09V15.91L12,19.85L19,15.91V8.09L12,4.15M14.93,8.27C16.35,8.27 17.5,9.42 17.5,10.84V13.5C17.5,14.9 16.35,16.05 14.93,16.05C13.5,16.05 12.36,14.9 12.36,13.5V10.84C12.36,9.42 13.51,8.27 14.93,8.27M14.92,9.71C14.34,9.71 13.86,10.18 13.86,10.77V13.53C13.86,14.12 14.34,14.6 14.92,14.6C15.5,14.6 16,14.12 16,13.53V10.77C16,10.18 15.5,9.71 14.92,9.71M11.45,14.76V15.96L6.31,15.93V14.91C6.31,14.91 9.74,11.58 9.75,10.57C9.75,9.33 8.73,9.46 8.73,9.46C8.73,9.46 7.75,9.5 7.64,10.71L6.14,10.76C6.14,10.76 6.18,8.26 8.83,8.26C11.2,8.26 11.23,10.04 11.23,10.5C11.23,12.18 8.15,14.77 8.15,14.77L11.45,14.76Z";
        }
    }
    $.$mol_icon_dice_d20 = $mol_icon_dice_d20;
})($ || ($ = {}));
//mol/icon/dice/d20/-view.tree/d20.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $dosha_branding extends $mol_page {
        ...
        body() {
            return [
                ...
                this.Reset_configs(),
                this.Random_configs(),
                this.Timer_dice_list(),
                this.Switch_brand_type(),
                this.Config_theme(),
        ...
        Dice_icon_normal() {
            const obj = new this.$.$mol_icon_dice_d6();
            return obj;
        }
        random_checked_normal(next) {
            if (next !== undefined)
                return next;
            return false;
        }
        Random_timer_normal() {
            ...
            obj.Icon = () => this.Dice_icon_normal();
            obj.checked = (next) => this.random_checked_normal(next);
            return obj;
        }
        Dice_icon_hard() {
            const obj = new this.$.$mol_icon_dice_d12();
            return obj;
        }
        random_checked_hard(next) {
            if (next !== undefined)
                return next;
            return false;
        }
        Random_timer_hard() {
            const obj = new this.$.$mol_check_icon();
            obj.Icon = () => this.Dice_icon_hard();
            obj.checked = (next) => this.random_checked_hard(next);
            return obj;
        }
        Dice_icon_hell() {
            const obj = new this.$.$mol_icon_dice_d20();
            return obj;
        }
        random_checked_hell(next) {
            if (next !== undefined)
                return next;
            return false;
        }
        Random_timer_hell() {
            const obj = new this.$.$mol_check_icon();
            obj.Icon = () => this.Dice_icon_hell();
            obj.checked = (next) => this.random_checked_hell(next);
            return obj;
        }
        Timer_dice_list() {
            const obj = new this.$.$mol_list();
            obj.rows = () => [
                this.Random_timer_normal(),
                this.Random_timer_hard(),
                this.Random_timer_hell()
            ];
            return obj;
        }
        brand_type(next) {
        ...
        Switch_brand_type() {
            const obj = new this.$.$mol_switch();
            obj.value = (next) => this.brand_type(next);
            obj.options = () => ({
        ...
        Color_luma() {
            const obj = new this.$.$mol_number();
            obj.hint = () => "luma";
            obj.value = (next) => this.luma(next);
            obj.value_min = () => -1;
            obj.value_max = () => 1;
            obj.precision_view = () => 0.2;
            obj.precision_change = () => 0.2;
            return obj;
        }
        Color_satur_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => "Насыщенность цвета";
            return obj;
        }
        satur(next) {
            if (next !== undefined)
        ...
        Color_satur() {
            const obj = new this.$.$mol_number();
            obj.hint = () => "satur";
            obj.value = (next) => this.satur(next);
            obj.value_min = () => -10;
            obj.value_max = () => 10;
            obj.precision_view = () => 1;
        ...
        Config_theme() {
            ...
            obj.rows = () => [
                ...
                this.Color_hue_text(),
                this.Color_hue(),
                this.Color_luma_text(),
                this.Color_luma(),
                this.Color_satur_text(),
                this.Color_satur()
            ];
            return obj;
        }
    ...
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "configs", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Copy_settings", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Branding_text", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Dice_icon_normal", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "random_checked_normal", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Random_timer_normal", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Dice_icon_hard", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "random_checked_hard", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Random_timer_hard", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Dice_icon_hell", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "random_checked_hell", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Random_timer_hell", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Timer_dice_list", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "brand_type", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Switch_brand_type", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Color_hue_text", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Color_luma_text", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "luma", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Color_luma", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Color_satur_text", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "satur", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Config_background", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Config_content", null);
    __decorate([
        $mol_mem
    ], $dosha_branding.prototype, "Save_configs", null);
    $.$dosha_branding = $dosha_branding;
})($ || ($ = {}));
//dosha/branding/-view.tree/branding.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        class $dosha_branding extends $.$dosha_branding {
            ...
            luma(next) {
                if (next)
                    document.documentElement.style.setProperty('--mol_theme_luma', `${next}deg`);
                return next ?? 0;
            }
            satur(next) {
                if (next)
                    document.documentElement.style.setProperty('--mol_theme_satur', `${next}deg`);
                return next ?? 0;
            }
        }
        __decorate([
...
//dosha/branding/branding.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $dosha_client_profile extends $mol_page {
        ...
        Branding() {
            const obj = new this.$.$dosha_branding();
            obj.title = () => "Брендинг";
            return obj;
        }
    }
    ...
    __decorate([
        $mol_mem
    ], $dosha_client_profile.prototype, "Branding", null);
...
(function ($) {
    class $dosha_company_report extends $mol_page {
        ...
        body() {
            return [
                this.Report_text(),
                this.Download_report_salary(),
                this.Download_report_people(),
                this.Download_report_rating(),
                this.Download_report_events(),
                this.Download_report_trainings(),
                this.Download_report_partners()
            ];
        }
        Report_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => "# Отчёты за ноябрь 2023 г.";
            return obj;
        }
        download() {
            const obj = new this.$.$mol_blob();
        ...
        Download_report_salary() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_salary.txt";
            obj.title = () => "Загрузить отчёт для оплаты по Филиалам";
            obj.blob = () => this.download();
            return obj;
        }
        Download_report_people() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_people.txt";
            obj.title = () => "Загрузить отчёт по сотрудникам";
            obj.blob = () => this.download();
            return obj;
        }
        Download_report_rating() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_rating.txt";
            obj.title = () => "Загрузить отчёт по рейтингу";
            obj.blob = () => this.download();
            return obj;
        }
        Download_report_events() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_events.txt";
            obj.title = () => "Загрузить отчёт по мероприятиям";
            obj.blob = () => this.download();
            return obj;
        }
        Download_report_trainings() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_trainings.txt";
            obj.title = () => "Загрузить отчёт по тренировкам";
            obj.blob = () => this.download();
            return obj;
        }
        Download_report_partners() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_report_events.txt";
            obj.title = () => "Загрузить отчёт по партнёрам и акциям";
            obj.blob = () => this.download();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Report_text", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "download", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_salary", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_people", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_rating", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_events", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_trainings", null);
    __decorate([
        $mol_mem
    ], $dosha_company_report.prototype, "Download_report_partners", null);
...
var $;
(function ($) {
    $mol_style_attach("dosha/company/report/report.view.css", "[dosha_company_report_body] {\n\talign-items: flex-start;\n}\n");
})($ || ($ = {}));
//dosha/company/report/-css/report.view.css.ts
;
"use strict";
var $;
(function ($) {
    class $dosha_company extends $mol_book2_catalog {
        ...
        spreads() {
            return {
                ...
                events: this.Events_page(),
                budget: this.Budget_page(),
                report: this.Report_page(),
                branding: this.Branding_page(),
                admin: this.Admin_page()
            };
        }
        Settings_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => this.settings_values();
            return obj;
        }
        safe(next) {
            if (next !== undefined)
        ...
        Settings_keep() {
            ...
            obj.title = () => "Разблокировать файлы настроек";
            obj.checked = (next) => this.safe(next);
            return obj;
        }
        Settings_update() {
            const obj = new this.$.$mol_button_major();
            obj.enabled = (next) => this.safe(next);
            obj.title = () => "Обновить файл конфигурации dosha.production.yaml";
            return obj;
        }
        settings_values(next) {
            if (next !== undefined)
                return next;
        ...
        Settings_change() {
            const obj = new this.$.$mol_textarea();
            obj.enabled = (next) => this.safe(next);
            obj.value = (next) => this.settings_values(next);
            return obj;
        }
        Settings_page() {
            const obj = new this.$.$mol_page();
            obj.title = () => "Настройки проекта";
            obj.body = () => [
                this.Settings_text(),
                this.Settings_keep(),
        ...
        Download_report_partners() {
            const obj = new this.$.$mol_button_download();
            obj.file_name = () => "dosha_detail_people_report.txt";
            obj.title = () => "Загрузить детальный отчёт по Пользователям";
            obj.blob = () => this.download();
            return obj;
        }
        People_page() {
        ...
        Admin_link() {
            const obj = new this.$.$mol_link_iconed();
            obj.title = () => "CMS Админка PROD";
            obj.uri = () => "https://2022831-koplenov.twc1.net/admin";
            return obj;
        }
        Admin_user() {
            const obj = new this.$.$mol_text();
            obj.text = () => "# Админ компании Кокос\n- First name: kokos\n- Last name: kompany\n- Email: kokos_company@dosha.com\n\n# Супер админ:\n- Login: **koplenov@gmail.com**\n- Password: **vu*5PZ5@xVV*PF**";
            return obj;
        }
        Admin_develop_link() {
            const obj = new this.$.$mol_link_iconed();
            obj.title = () => "CMS Админка Локальная";
            obj.uri = () => "http://localhost:1337/admin/";
            return obj;
        }
        Admin_page() {
            const obj = new this.$.$mol_page();
    ...
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Settings_text", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "safe", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Settings_keep", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Settings_update", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "settings_values", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Settings_change", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Settings_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "People_text", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "download", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Download_report_partners", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "People_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Events_text", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Download_report_events", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Events_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Budget_text", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Download_report_budget", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Budget_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Report_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Branding_page", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Admin_link", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Admin_user", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Admin_develop_link", null);
    __decorate([
        $mol_mem
    ], $dosha_company.prototype, "Admin_page", null);
...
(function ($) {
    class $dosha_client extends $mol_view {
        ...
        Coins_page() {
            const obj = new this.$.$dosha_client_coins();
            return obj;
        }
        History_page() {
        ...
        Secure() {
            ...
            obj.menu_title = () => "👣 Добрый Шаг";
            obj.param = () => "client";
            obj.menu_filter_enabled = () => false;
            obj.plugins = () => [
                this.Theme()
            ];
            obj.menu_tools = () => [
